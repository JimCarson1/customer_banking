...
def main():
    ...
    # ADD YOUR CODE HERE
    print(f"Your savings account earned ${interest_earned:.2f} in interest and your new balance is ${updated_cd_balance:.2f}.")
